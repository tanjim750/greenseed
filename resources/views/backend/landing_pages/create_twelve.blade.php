@extends('backend.app')
@section('title', 'Create Landing Page (Design 11 — Honey)')
@section('content')
...
<div class="content-wrapper">
    <div class="container-fluid py-3">
        <form action="{{ route('admin.landing_pages_twelve.store') }}" method="POST" enctype="multipart/form-data" id="ajax_form">
            @csrf
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    {{-- ৩.৫. বিস্তারিত বৈশিষ্ট্য (অর্গানিক/স্পেশাল ফিচার) --}}
                    <div class="premium-card">
                        ...
                        <div class="card-body p-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="special_feature_title" class="form-control" value="কেন আমাদের মধু সত্যিকারের অর্গানিক?">
                            </div>
                            <div class="row">
                                {{-- বাম কলাম --}}
                                <div class="col-md-6 border-end">
                                    ...
                                    <div class="section-row">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="sf_{{ $i }}_title" class="form-control" placeholder="যেমন: প্রাকৃতিক চাক থেকে সংগ্রহ">
                                        </div>
                                        <div>
                                            <label class="small fw-bold">বিস্তারিত {{ $i }}</label>
                                            <input type="text" name="sf_{{ $i }}_desc" class="form-control" placeholder="সংক্ষিপ্ত বর্ণনা">
                                        </div>
                                    </div>
                                    @endfor
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="section-row">
                                        <div class="mb-2">
                                            <label class="small fw-bold">টাইটেল {{ $i }}</label>
                                            <input type="text" name="sf_{{ $i }}_title" class="form-control" placeholder="যেমন: নিজস্ব তত্ত্বাবধানে প্রক্রিয়াজাত">
                                        </div>
                                        <div>
                                            <label class="small fw-bold">বিস্তারিত {{ $i }}</label>
                                            <input type="text" name="sf_{{ $i }}_desc" class="form-control" placeholder="সংক্ষিপ্ত বর্ণনা">
...
<script>
    $(document).ready(function() {
        ...
        // Add Package Row — event delegation (DOM ready agei cholbe)
        let pkgIndex = 1;
