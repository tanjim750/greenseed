@extends('backend.app')
@section('title', 'Landing Pages (Type 13 — Design 12 — Fashion)')
                ...
                <div class="premium-card">
                    <div class="premium-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <h4 class="premium-title">Landing Pages (Type 13 — Design 12 — Fashion)</h4>
                        </div>
                        <a href="{{ route('admin.landing_pages_thirteen.create') }}" class="btn-create">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Headline"><div class="fw-bold fs-6 mb-1 text-dark">{{ $item->title1 }}</div>
                                            <span class="badge-soft-danger"><i class="fas fa-layer-group me-1"></i> Layout 13 — Design 12 — Fashion</span>
                                        </td>
                                        ...
                                        <td data-label="Live URL"><a href="{{ route('front.landing_pages_thirteen.view_page', $item->id) }}" target="_blank" class="link-view">
                                                Visit Page <i class="fas fa-external-link-alt" style="font-size: 11px;"></i>
                                            </a>
                                        </td>
                                        <td data-label="Actions" class="text-center">
                                            <div class="d-flex justify-content-center">
                                                <a href="{{ route('admin.landing_pages_thirteen.edit', $item->id) }}" class="action-btn edit" data-bs-toggle="tooltip" title="Edit Content">
                                                    <i class="fas fa-pen"></i>
                                                </a>
                                                <a href="{{ route('admin.landing_pages.color', $item->id) }}" class="action-btn color" data-bs-toggle="tooltip" title="Settings">
                                                    <i class="fas fa-paint-roller"></i>
                                                </a>
                                                <form action="{{ route('admin.landing_pages_thirteen.destroy', $item->id) }}" method="POST" class="d-inline delete-form">
                                                    @csrf
                                                    @method('DELETE')
