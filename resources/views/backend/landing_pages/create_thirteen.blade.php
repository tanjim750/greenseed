@extends('backend.app')
@section('title', 'Create Landing Page (Design 12 — Fashion)')
@section('content')
...
<div class="content-wrapper">
    <div class="container-fluid py-3">
        <form action="{{ route('admin.landing_pages_thirteen.store') }}" method="POST" enctype="multipart/form-data" id="ajax_form">
            @csrf
