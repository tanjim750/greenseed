...
<div class="row">
  <div class="col-12">
    <div class="page-title-box d-flex justify-content-between align-items-center flex-wrap">
      <div>
        <h4 class="page-title mb-1">Size Manage</h4>
        <ol class="breadcrumb m-0">
          <li class="breadcrumb-item"><a href="javascript:void(0);">SIS</a></li>
          <li class="breadcrumb-item"><a href="javascript:void(0);">CRM</a></li>
          <li class="breadcrumb-item active sz_manage">Size Manage</li>
        </ol>
      </div>
    </div>
  </div>
        ...
        <div class="card card-modern">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-2 flex-wrap">
                    <div>
                        <h5 class="mb-0" style="font-weight:600; color:#0f172a;">Size List</h5>
                        <small class="text-muted">Manage available sizes</small>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-label="Action">
                                        @if($key == 0)
                                            {{-- প্রথম size lock: edit/delete নেই --}}
                                            @can('size.edit')
                                            @endcan
                                            @can('size.delete')
                                            @endcan
                                        @else
                                            ...
                                            @can('size.delete')
                                            <a href="{{ route('admin.sizes.destroy',[$item->id])}}"
